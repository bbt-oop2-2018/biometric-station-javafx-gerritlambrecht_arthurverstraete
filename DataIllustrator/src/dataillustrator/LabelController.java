 ...
 * @author Arthur
 */
public class LabelController implements Initializable, IMqttDataHandler{
        String beginOfTemp = "#";
        ...
        String endOfData = "]";  
        int xValue = 0;
        private final int MINIMUM_HEARTBEAT = 40;
        private final int MAXIMUM_HEARTBEAT = 200;
    ...
    private void clearData(ActionEvent event) {
        ...
        temperatureValues.getData().clear();
        heartbeatValues.getData().clear();
        ...
        Platform.runLater(new Runnable () {
            ...
            public void run() {
                ...
                if (indexTemp >= 0 && indexHeartbeat >= 0 && indexAccelero >= 0 && indexEnd >= 0 && indexY >= 0 && indexZ >= 0) {
                    ...
                    lmeasure.setText("Last measure: " + time);
                    ...
                    if (hbint < MAXIMUM_HEARTBEAT && hbint > MINIMUM_HEARTBEAT) {
                        ...
                        if (update) {
                        heartbeat.setText("No valid heartbeat!");
